...
describe('Theme Token System — generate-theme.mjs', () => {
  ...
  afterAll(() => {
    // Restore generated-theme.css so dev server and other tests still work
  ...
  describe('Erfolgreiche CSS-Generierung', () => {
    // Force default theme for these tests, regardless of .env.local
    const defaultEnv = { ...process.env, NEXT_PUBLIC_THEME: 'default' }
