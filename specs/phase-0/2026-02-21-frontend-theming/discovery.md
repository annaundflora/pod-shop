...
| 26 | Soll Storybook für Component-Entwicklung und visuelle Tests verwendet werden? | Nein. Kein Storybook. Components werden direkt im laufenden Next.js Dev-Server entwickelt und getestet. Kein zweiter Dev-Server, kein extra Build-Step. |
