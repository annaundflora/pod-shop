...
| 4 | Block Registry + Page Renderer | Block Registry (type → Component), Data Loaders (wordpress, woocommerce, inline), Page Renderer Component, 4 Block-Typen (HeroBlock, ProductGridBlock, CategoryShowcaseBlock, UspBarBlock), WP Custom Fields PHP Plugin (register_post_meta), Homepage auf Block-Config umstellen | Homepage rendert identisch über Block-System. WP Custom Fields in GraphQL querybar. Fallback bei fehlendem Block. Data Loader Tests. | Slice 3 |
